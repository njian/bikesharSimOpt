...
if __name__ == '__main__':
    ...
    fileName = "AverageAllocationid17"
    ...
    logging.info('Purpose of the run: restart from AverageAllocationid17CapsTableRn')
    ...
    capacity = cPickle.load(open('./outputsDO/AverageAllocationid17CapsTableRnCapsCapacity.p', 'r'))
    level = cPickle.load(open('./outputsDO/AverageAllocationid17CapsTableRnCapsLevel.p', 'r'))
    for sid in sM:
